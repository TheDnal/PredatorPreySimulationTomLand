...
public class MapMakerScript : MonoBehaviour
{
    ...
    public Slider s_mapWidth, s_mapHeight, s_seed,s_offsetX,s_offsetY, s_seaLevel;
    public void Start()
    {
    ...
    public void UpdateMap()
    {
        ...
        MapGenerator.instance.Generate(mapDimensions, seed, offset, seaLevel);
    }
